...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg fixed-top py-3 bg-success" id="mainNav">
            <div class="container">
               <img class="d-none d-lg-block" style="border-radius: 70%;" src="assets/img/vector.jpg" width="45" height="45"> &nbsp
